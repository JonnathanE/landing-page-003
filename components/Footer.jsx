			...
			<div className='mx-auto max-w-screen-xl px-6 pt-16 sm:px-8'>
				<div className='grid grid-cols-1 gap-y-6 gap-x-6 md:!grid-cols-6 md:gap-8 xs:grid-cols-2'>
					<div className='mb-4  flex flex-col xs:col-span-2'>
						<span className='text-xl font-bold capitalize'>JEDE</span>
						...
						<ul
							...
							className='mt-4 flex items-center space-x-4 flex-wrap'
						>
...
const LinkedInFullIcon = ({ height, width, ...otherProps }) => {
	return (
...
const FacebookIcon = ({ height, width, ...otherProps }) => {
	return (
...
const TiktokIcon = ({ height, width, ...otherProps }) => {
	return (
		<svg viewBox='0 0 24 24' height={height} width={width} {...otherProps}>
...
const LinkedInIcon = ({ height, width, ...otherProps }) => {
	return (
		<svg viewBox='0 0 24 24' height={height} width={width} {...otherProps}>
...
const YoutubeIcon = ({ height, width, ...otherProps }) => {
	return (
		<svg viewBox='0 0 24 24' height={height} width={width} {...otherProps}>

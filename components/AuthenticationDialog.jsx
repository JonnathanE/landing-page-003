...
// isOpen: boolean;
//   onClose: () => void;
const AuthenticationDialog = ({ isOpen, onClose }) => {
	return (
		<>
			<Dialog
				as='div'
				...
				<div className='min-h-screen px-4 text-center'>
					...
					<div className='my-8 inline-block w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 align-middle shadow-xl transition-all dark:bg-gray-800'>
						...
						<div className='my-4 flex items-center'>
							...
							<span className='relative px-3 text-lg font-semibold'>Or</span>
							<span className='block h-0.5 w-full bg-slate-400'></span>
						</div>
...
const FacebookColorfulIcon = ({ height, width, ...otherProps }) => {
	return (
...
const LinkedinColorfulIcon = ({ height, width, ...otherProps }) => {
	return (
...
const GoogleColorfulIcon = ({ height, width, ...otherProps }) => {
	return (
